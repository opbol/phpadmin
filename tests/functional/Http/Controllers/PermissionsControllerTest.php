...
class PermissionsControllerTest extends FunctionalTestCase {
	...
	public function test_permissions_list() {
		...
		$this->visit('dashboard/permission')
	...
	public function test_save_role_permissions() {
		...
		$this->seePageIs('dashboard/permission')
	...
	public function test_create_permission() {
		...
		$this->visit(route('dashboard.permission.index'))
			->click('Add Permission')
			->seePageIs('dashboard/permission/create')
			->submitForm('Create Permission', $data);

		$this->seePageIs(route('dashboard.permission.index'))
	...
	public function test_update_permission() {
		...
		$this->visit('dashboard/permission')
			...
			->seePageIs("dashboard/permission/{$permission->id}/edit")
	...
	public function test_delete() {
		$this->expectsEvents(\App\Events\Permission\Deleted::class);

		$permission = factory(Permission::class)->create();

		$this->delete(route('dashboard.permission.destroy', $permission->id))
			->followRedirects();
